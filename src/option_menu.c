...
static const u8 *const sOptionMenuItemsNamesCustom[MENUITEM_CUSTOM_COUNT] =
{
    ...
    [MENUITEM_CUSTOM_FOLLOWER]    = gText_Follower,
...
static const u8 sText_Desc_FollowerOn[]         = _("The first POKéMON in your party\nfollows you around.");
...
void CB2_InitOptionMenu(void)
{
    ...
    case 6:
        ...
        sOptions->sel_custom[MENUITEM_CUSTOM_FOLLOWER]    = gSaveBlock2Ptr->optionsFollowerVisible;
...
static void Task_OptionMenuSave(u8 taskId)
{
    ...
    gSaveBlock2Ptr->optionsFollowerVisible  = sOptions->sel_custom[MENUITEM_CUSTOM_FOLLOWER];
